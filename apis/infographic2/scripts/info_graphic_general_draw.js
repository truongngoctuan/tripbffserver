...
const draw_01_01_01 = require("./info_graphic_01_01/info_graphic_01_01");
const draw_01_01_02 = require("./info_graphic_01_01/info_graphic_01_02");
const draw_01_01_others = require("./info_graphic_01_01/info_graphic_01_others");
...
async function info_v_01_01(trip, infographicType) {
  ...
  if (infographicType == INFOGRAPHIC_TYPE.FIRST_RELEASED) {
    if (numberOfLocations == 1) {
      ...
      await draw_01_01_02.draw(canvasAdaptor, trip);
    } else {
      await draw_01_01_others.draw(canvasAdaptor, trip);
    }
  }
